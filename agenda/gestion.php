...
<table >
        <tr height="50px"><td width="150px"><strong>Thématique</strong></td><td><input type="text" name="théma" value="<?php echo $loc;?>"/></td></tr>
        <tr height="50px"><td><strong>Salle</strong></td><td><input type="text" name="salle" value="<?php echo $eve;?>"/></td></tr>
		<tr height="50px"><td><strong>Horraire</strong></td><td><input type="text" name="horraire" value="<?php echo $eve;?>"/></td></tr>
        <tr height="50px">
        <?php
			if($mod==0)
